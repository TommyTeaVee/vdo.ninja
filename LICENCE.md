The Brevity source repository is governed by the GNU AFFERO GENERAL PUBLIC LICENSE. (AGPL-3.0)
That AGPL-3.0 licence can be found here: [AGPLv3.md](https://github.com/steveseguin/vdo.ninja/blob/master/AGPLv3.md)

In essence, Brevity is open-source and free to use, both for commercial and non-commercial use.
...
Contributors to the Brevity project must first agree to the Contributor License Agreement (CLA).
