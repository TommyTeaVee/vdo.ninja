...
dual is an example of how to have two Brevity windows (or any windows really) open on the same page; Picture-in-Picture style
...
midi demonstrates the MIDI API for Brevity
...
iframe.outbound-stats.html demostrates how to get stats from Brevity using the IFRAME API
...
zoom.html is a tool for letting you publish into Brevity, but then full-screen the window once setup, allowing for window-capturing into zoom.

obs_remote is also hosted on github elsewhere, but it's an example of how to remotely control OBS using Brevity's tunneling abilities
